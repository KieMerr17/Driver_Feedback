...
def site_information():
    ...
    st.write("- click the generate button.")
    st.write("Your feedback will be displayed in a text box below for you to review. This can be edited if you require before copying into your destination")
